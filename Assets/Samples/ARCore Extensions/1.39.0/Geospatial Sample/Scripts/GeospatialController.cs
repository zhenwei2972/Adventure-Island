...
namespace Google.XR.ARCoreExtensions.Samples.Geospatial
{
    ...
    public class GeospatialController : MonoBehaviour
    {
        ...
        public GameObject SpawnAnchors(double _lat, double _lng )
        {
            if (EarthManager.EarthTrackingState == TrackingState.Tracking)
            {
                var anchor =
                    AnchorManager.AddAnchor(
                        ...
                        0,
                        Quaternion.identity);
                GameObject anchoredAsset = Instantiate(LocationIcon, anchor.transform);
                return anchoredAsset;
              //  anchoredAsset.transform
            }
            return null;
        }
    }
